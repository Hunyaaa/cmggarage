    ...
    <section id="why-us" className="py-24 bg-secondary grunge-overlay" ref={ref}>
      <div className="container relative z-10">
        <motion.div
          ...
          <h2 className="font-display text-3xl md:text-5xl text-foreground mb-4">MIÉRT VÁLASSZ ENGEM?

          </h2>
          <div className="scratch-line w-32 mx-auto mb-6" />
          <p className="font-body text-muted-foreground max-w-xl mx-auto">Nagykanizsán prémium autóápolási szolgáltatást nyújtok – a legapróbb részletekig
